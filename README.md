...
* **Lịch sử giao dịch gần đây (Hợp nhất):** 
  ...
  * Hiển thị số tiền màu xanh lá cây kèm dấu `+` đối với Khoản thu nhập; số tiền màu đỏ kèm dấu `-` đối với Khoản chi tiêu và Khoản gửi tiết kiệm.
...
* **Tiến độ tích lũy:** Biểu thị phần trăm và số tiền còn thiếu để đạt mục tiêu tiết kiệm tháng. Khi tổng số tiền tích lũy (bao gồm tiết kiệm ban đầu và các khoản trích gửi) bằng mục tiêu, trạng thái tự động chuyển sang "Hoàn thành" kèm thông điệp chúc mừng.
* **Cập nhật hồ sơ tài chính:** Cho phép thay đổi nhanh ba chỉ số cấu hình bất kỳ lúc nào: Hạn mức chi tiêu tháng, Mục tiêu tiết kiệm tháng, Khoản tiết kiệm ban đầu.
